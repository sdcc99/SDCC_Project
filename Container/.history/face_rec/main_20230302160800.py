...
def sendPhoto_to_rabbitmq(encoded_string):
    ...
    channel2.basic_publish(exchange='', routing_key='coda_receive', body=encoded_string)
...
def recognition(immagine):
    ...
    cv2.imwrite("/face_rec/received_image.png", image)

    with open("/face_rec/received_image.png", "rb") as image_file:
